 ...
 */
router.get('/presales-summary', authorize('admin', 'manager'), dashboardController.getPreSalesSummary);
 ...
 */
router.get('/marketing-summary', authorize('admin', 'manager'), dashboardController.getMarketingSummary);
 ...
 */
router.get('/executives', authorize('admin', 'manager'), dashboardController.getExecutives);
